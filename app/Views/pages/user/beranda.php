              ...
              <div class="col-md-7">
                <form action="/daftar" method="post" role="form" class="php-email-form">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea name="alamat" class="form-control" cols="35" rows="4" placeholder="Alamat" required></textarea>
                      </div>
                    </div>
                    <div class="col-md-12 my-3">
                      <div class="mb-3">
                        ...
                        <div class="sent-message">Rukomu sedang ditinjau. <a href="/admin">Login</a> untuk melengkapi data ruko</div>
                      </div>
                    </div>
